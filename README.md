...
spec:
  ...
  pstates:
    ...
    min: "50%" # scalar is also accepted; if missing, it defaults to the hardware min
    governor: "powersave"
      ...
      f:status:
        f:powerProfiles:
          k:{"name":"application"}:
            ...
            f:config: {}
            f:name: {}
    manager: powerprofile-controller.application
    operation: Apply
    subresource: status
  - fieldsV1:
      f:status:
        f:powerProfiles:
          k:{"name":"balance-performance"}:
            .: {}
            f:config: {}
            f:name: {}
    manager: powerprofile-controller.balance-performance
    operation: Apply
    subresource: status
  - fieldsV1:
      f:status:
        f:powerProfiles:
          k:{"name":"performance"}:
            ...
            f:config: {}
            f:name: {}
    manager: powerprofile-controller.performance
    operation: Apply
    subresource: status
  - fieldsV1:
      f:status:
        f:powerProfiles:
          k:{"name":"shared"}:
            ...
            f:config: {}
            f:name: {}
    manager: powerprofile-controller.shared
    operation: Apply
    subresource: status
  - fieldsV1:
      f:status:
        f:cpuPools:
          ...
          f:shared:
            ...
            f:powerNodeConfig: {}
            f:powerProfile: {}
    manager: powernodeconfig-controller
    operation: Apply
    subresource: status
  - fieldsV1:
      f:status:
        f:cpuPools:
          f:exclusive:
            k:{"podUID":"8fb49327-3e69-4b68-8e64-b21ab0660462"}:
              .: {}
              f:pod: {}
              f:podUID: {}
              f:powerContainers: {}
    manager: powerpod-controller.8fb49327-3e69-4b68-8e64-b21ab0660462
    operation: Apply
    subresource: status
...
The `managedFields` section shows SSA field ownership — each controller owns only its specific fields,
allowing independent updates without conflicts.
